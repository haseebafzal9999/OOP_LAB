...
namespace Task_Week5.BL
{
    ...
    {
        public Student(string name, int age, float fscMarks, float ecatMarks, float matricMarks, List<DegreeProgram> degreeList)
        {
            studentName=name;
            this.age=age;
        ...
        public Student(int Id,string name, int age, float fscMarks, float ecatMarks, float matricMarks, List<DegreeProgram> degreeList,float totalFees,int degreeId)
        {
            this.Id=Id;
            studentName = name;
            this.age = age;
        ...
        public Student(int Id, string name, int age, float fscMarks, float ecatMarks, float matricMarks, float totalFees, int degreeId)
        {
            this.Id = Id;
            studentName = name;
            this.age = age;
        ...
        {
            merit = (fscMarks * 0.40f) + (ecatMarks * 0.3f) + (matricMarks * 0.3f);
        }
